...
class MailService {
    ...
    sendMail = async (
        ...
        return recordEmailAttempt(template, classifyEmailFailureReason, () =>
    ...
    sendOrganizationInvitation = async (
        ...
        return this.sendMail(
            {
                to: mail,
                subject: `${organizationName} 邀請你加入`,
                text: `你收到 ${organizationName} 的成員邀請。請登入受邀的 Email 帳號後開啟連結：${url}\n\n連結將於 7 天後失效。`,
            },
