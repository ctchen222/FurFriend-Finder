...
| C1.3 | ✅ 平台審核、公開資料投影、發布／停權；通知補強見本批驗收 |
| C1.4 | ✅ 建立組織、後台切換、OAuth 深連結、公開名錄與介紹 |
| C2.1／C2.2 | ✅ 動物刊登、圖片、來源區分、管理與公開動物頁 |
| 通知補強 | 核准／退回／停權／恢復的站內通知與 outbox、寄送復原、卡片樣式；見 [本批驗收](review-notifications-acceptance.md) |
| C2 後續 | 尚未實作：條件／別名／pg_trgm 動物搜尋 |
| C3 | 認養申請、審核、結案及通知 |
